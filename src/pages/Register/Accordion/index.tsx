              ...
              <ul>
                <li>
                  ...
                  <div className="contents">
                    ...
                    <div className="indentation">
                      1. "사용자"란 지스트 청원 에 접속하여 본 약관에 따라
                      Better IT팀이 제공하는 서비스를 이용하는 회원 및 비회원을
                      말합니다.
                      <br />
                  ...
                  <div className="contents">
                    ...
                    가입함으로써 효력이 발생하며, 청원 홈페 이지의 서비스 제공
                ...
                <li>
                  ...
                  <div className="contents">
                    ...
                    청원 홈 페이지의 회원 가입 신청 절차에 따라 본인확인을 거쳐
                    본 이용약관 및 개인정보처리방침 등 에 "동의" 여부를
                    표시하고, 개인정보를 기재함으로써 회원에 가입합니다.
                  </div>
                  <div className="contents">
                    제5조(회원 탈퇴 및 자격 상실)
                    <br />
                  ...
                  <div className="contents">
                    ...
                    제공을 일시적으로 중단할 수 있 습니다. 또한, 운영상 상당한
                    이유가 있는 경우 현재 제공되는 서비스를 새로운 서비스로 교
                    체 또는 중단할 수 있습니다.
                    <br />
                    &#9313; 제1항에 의한 서비스 중단의 경우에는 Better IT팀은
                    제8조 제2항에서 정한 방법으로 이용자에게 통지합니다. 다만,
                    Better IT팀이 통제할 수 없는 사유로 인한 서비스의 중단(시스
                    템 관리자의 고의·과실이 없는 정보시스템, 서버, 정보기기,
                    네트워크의 장애발생 등)으로 인 하여 사전 통지가 불가능한
                    경우에는 그러하지 아니합니다.
                  </div>
                  <div className="contents">
                    제8조(이용자에 대한 통지)
                    ...
                    경우 지스트 청원 게시 판 및 서비스 화면에 게시함으로써 개별
                    통지에 갈음할 수 있습니다.
                  </div>
                  <div className="contents">
                    제9조(개인정보보호)
                    ...
                    보호하기 위하여 노력합니다. 다만, Better IT팀이 운영하는 에
                    포함된 링크 또는 배너를 클릭하여 다른 사이트로 옮겨갈
                    경우에는 해당 사이트의 개인정보보호방침 에 따릅니다.
                    <br />
                  ...
                  <div className="contents">
                    ...
                    지속 적이고, 안정적으로 서비스를 제공하기 위해서 노력합니다.
                    <br />
                    &#9313; Better IT팀은 이용자가 안전하게 인터넷 서비스를
                    이용할 수 있도록 개인정보의 안전성 확보에 필요한
                    기술적·관리적 및 물리적 보안 조치 를 취합니다.
                  </div>
                  <div className="contents">
                  ...
                  <div className="contents">
                    ...
                    <div className="indentation">
                      ...
                      공서양속에 반하는 정보를 메일로 송 신하거나 공개 또는
                      게시하는 행위
                      <br />
                      ...
                      정보를 전송 또는 게시하는 행 위 2 제1항에 해당하는 행위를
                      한 이용자가 있을 경우 Better IT팀은 이용자의 회원자격을 적
                      정한 방법으로 제한, 정지 또는 상실시킬 수 있습니다. 3
                      이용자는 그 귀책사유로 인하여 Better IT팀이나 다른
                      이용자가 입은 손해를 배상할 책 임이 있습니다.
                    </div>
                  </div>
                  <div className="contents">
                    제13조(공개게시물의삭제등)
                    <br />
                    &#9312; 이용자가 게재한 공개 게시물의 내용이 다음 각호에해
                    당하는 경우 지스트 청원은 이용자에게 사전 통지 없이 해당
                    ...
                    <div className="contents">
                      ...
                      이익이나 서비스를 통하여 얻은 자료 로 인한 손해에 관하여
                      책임을 지지 않습니다.
                      <br />
                ...
                <li>
                  ...
                  <div className="contents">
                    * 지스트 청원은 다음 목적을 위해서 개인 정보를 수집하며,
                    수집된 개인정보는 정해 진 목적 이외의 용도로는 이용되지
                    않습니다.
                    <br />
                    1. 지스트 청원 회원 가입 및 관리 회원 가입의사 확인, 회원제
                    서비스 또는 제한적 본인 확인제에 따른 본인확인, 개인식별, 부
                    정이용방지
                    <br />* 수집 목적, 수집 항목, 개인정보의 보유·이용기간, 동의
                    거부권·동의 거부에 따른 불이익 내 용이 변경될 경우
